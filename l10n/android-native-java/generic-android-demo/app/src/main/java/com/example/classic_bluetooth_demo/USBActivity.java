...
public class USBActivity extends Activity {
    ...
    printModel.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (curCmd.equals("tspl")) {
          GenericTSPL _gtspl = PrintUtil.getInstance().tspl().clear()
              .page(TPage.builder().width(100).height(150).build())
              .direction(TDirection.builder().direction(TDirection.Direction.UP_OUT).mirror(TDirection.Mirror.NO_MIRROR)
                  .build())
              ...
              .text(TText.builder().x(30).y(120).font(Font.TSS24).xmulti(1).ymulti(1)
                  .content("发  件  人：张三 (电话 874236021)").build())
              ...
              .text(TText.builder().x(30).y(760).font(Font.TSS16).xmulti(1).ymulti(1).content("寄件人承诺不含有法律规定的违禁物品。")
                  .build())
              ...
              .text(TText.builder().x(130).y(625).font(Font.TSS24).xmulti(1).ymulti(1).content("2015-10-30 09:09")
                  .build())
          ...
          GenericCPCL _gcpcl = PrintUtil.getInstance().cpcl().clear()
              ...
              .line(CLine.builder().startX(0).startY(88 + 128 + 80 + 144).endX(598 - 56 - 16).endY(88 + 128 + 80 + 144)
                  .lineWidth(2).build())
              .line(CLine.builder().startX(0).startY(88 + 128 + 80 + 144 + 128).endX(598 - 56 - 16)
                  .endY(88 + 128 + 80 + 144 + 128).lineWidth(2).build())
              .line(CLine.builder().startX(52).startY(88 + 128 + 80).endX(52).endY(88 + 128 + 80 + 144 + 128)
                  .lineWidth(2).build())
              .line(CLine.builder().startX(598 - 56 - 16).startY(88 + 128 + 80).endX(598 - 56 - 16).endY(664)
                  .lineWidth(2).build())
              .bar(CBar.builder().x(120).y(88 + 12).lineWidth(1).height(80).content("1234567890")
                  .codeType(com.printer.psdk.cpcl.mark.CodeType.CODE128).codeRotation(CodeRotation.ROTATION_0).build())
              .text(CText.builder().textX(120 + 12).textY(88 + 20 + 76).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("1234567890").build())
              .text(CText.builder().textX(12).textY(88 + 128 + 80 + 32).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("收").build())
              .text(CText.builder().textX(12).textY(88 + 128 + 80 + 96).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("件").build())
              .text(CText.builder().textX(12).textY(88 + 128 + 80 + 144 + 32)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("发").build())
              .text(CText.builder().textX(12).textY(88 + 128 + 80 + 144 + 80)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("件").build())
              .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 128 + 16)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("签收人/签收时间").build())
              .text(CText.builder().textX(430).textY(88 + 128 + 80 + 144 + 128 + 36)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("月").build())
              .text(CText.builder().textX(490).textY(88 + 128 + 80 + 144 + 128 + 36)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("日").build())
              .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 24).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("收姓名" + " " + "13777777777").build())
              .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 24 + 32)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("南京市浦口区威尼斯水城七街区七街区").build())
              .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 24)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("名字" + " " + "13777777777").build())
              .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 24 + 32)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("南京市浦口区威尼斯水城七街区七街区").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(88 + 128 + 80 + 104)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("派").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(88 + 128 + 80 + 160)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("件").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(88 + 128 + 80 + 208)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("联").build())
              ...
              .line(CLine.builder().startX(0).startY(696 + 80 + 136).endX(598 - 56 - 16).endY(696 + 80 + 136)
                  .lineWidth(2).build())
              ...
              .bar(CBar.builder().x(320).y(696 - 4).lineWidth(1).height(56).content("1234567890")
                  .codeType(com.printer.psdk.cpcl.mark.CodeType.CODE128).codeRotation(CodeRotation.ROTATION_0).build())
              .text(CText.builder().textX(320 + 8).textY(696 + 54).font(com.printer.psdk.cpcl.mark.Font.TSS16)
                  .content("1234567890").build())
              .text(CText.builder().textX(12).textY(696 + 80 + 35).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("发").build())
              .text(CText.builder().textX(12).textY(696 + 80 + 84).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("件").build())
              .text(CText.builder().textX(52 + 20).textY(696 + 80 + 28).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("名字" + " " + "13777777777").build())
              .text(CText.builder().textX(52 + 20).textY(696 + 80 + 28 + 32).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("南京市浦口区威尼斯水城七街区七街区").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(696 + 80 + 50).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("客").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(696 + 80 + 82).font(com.printer.psdk.cpcl.mark.Font.TSS24)
                  .content("户").build())
              .text(CText.builder().textX(598 - 56 - 5).textY(696 + 80 + 106)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("联").build())
              .text(CText.builder().textX(12 + 8).textY(696 + 80 + 136 + 22 - 5)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("物品：" + "几个快递" + " " + "12kg").build())
              .box(CBox.builder().topLeftX(598 - 56 - 16 - 120).topLeftY(696 + 80 + 136 + 11)
                  .bottomRightX(598 - 56 - 16 - 16).bottomRightY(968 - 11).lineWidth(2).build())
              .text(CText.builder().textX(598 - 56 - 16 - 120 + 17).textY(696 + 80 + 136 + 11 + 6)
                  .font(com.printer.psdk.cpcl.mark.Font.TSS24).content("已验视").build());
    ...
    status_btn.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (result != null) {
          ...
          showMessage(getString(R.string.no_status_info));
        }
  ...
  private class MyHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        case USB.OPEN:
          showMessage(getString(R.string.usb_opened));
          switch_Usb.setText(R.string.close_usb);
          isOpen = true;
          break;
        case USB.ATTACHED:
          showMessage(getString(R.string.usb_attached));
          USBConnectedDevice usbConnectedDevice = usb.openUsb();
          if (usbConnectedDevice != null) {
            PrintUtil.getInstance().init(usbConnectedDevice);
            switch_Usb.setText(R.string.close_usb);
          ...
          break;
        case USB.DETACHED:
          showMessage(getString(R.string.usb_detached));
          switch_Usb.setText(R.string.open_usb);
          isOpen = false;
          break;
  ...
  public void printerStatus(byte[] bytes) {
    if (bytes.length == 1) {
      if (bytes[0] == 0x00) {
        showMessage(getString(R.string.printer_normal));
      }
      if ((bytes[0] & 0x01) == 0x01) {
        showMessage(getString(R.string.printer_open));
      }
      if ((bytes[0] & 0x02) == 0x02) {
        showMessage(getString(R.string.paper_error));
      }
      if ((bytes[0] & 0x04) == 0x04) {
        showMessage(getString(R.string.paper_empty));
      }
      if ((bytes[0] & 0x20) == 0x20) {
        showMessage(getString(R.string.printer_printing));
      }
      if ((bytes[0] & 0x10) == 0x10) {
        showMessage(getString(R.string.printer_paused));
      }
      if ((bytes[0] & 0x80) == 0x80) {
        showMessage(getString(R.string.printer_overheat));
      }
    }
  }
  ...
  private byte[] safeWriteAndRead(PSDK psdk) {
    try {
      ...
      if (!reporter.isOk()) {
        throw new IOException(getString(R.string.write_failed), reporter.getException());
      }
      Thread.sleep(200);
  ...
  private void safeWrite(PSDK psdk) {
    try {
      ...
      Util.show(USBActivity.this, getString(R.string.send_success));
    } catch (Exception e) {
      e.printStackTrace();
      Util.show(USBActivity.this, getString(R.string.send_failed_reconnect));
    }
  }

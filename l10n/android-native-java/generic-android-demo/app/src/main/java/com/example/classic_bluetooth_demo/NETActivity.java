...
public class NETActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    save_address.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        if (address.isEmpty()) {
          Util.show(NETActivity.this, getString(R.string.address_only_empty));
          return;
        }
        ...
        Util.show(NETActivity.this, getString(R.string.save_success));
      }
    });
    switch_net.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (isOpen && network != null) {
          ...
          switch_net.setText(R.string.connect);
          isOpen = false;
        } else {
          String address = et_address.getText().toString();
          String port = et_port.getText().toString();
          if (address.isEmpty() || port.isEmpty()) {
            Util.show(NETActivity.this, getString(R.string.address_empty));
            return;
          }
          network = new Network(address, Integer.parseInt(port));

          PdfUtil.showLoading(NETActivity.this, getString(R.string.connecting));
          new Thread(() -> {
            ...
            runOnUiThread(() -> {
              ...
              if (netConnectedDevice != null) {
                ...
                Util.show(NETActivity.this, getString(R.string.connect_success));
                switch_net.setText(R.string.disconnect);
                isOpen = true;
              } else {
                Util.show(NETActivity.this, getString(R.string.connect_failed_check_address));
              }
            });
          }).start();
        }
    ...
    printPdf.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if (!isOpen) {
          Util.show(NETActivity.this, getString(R.string.not_connected));
          return;
        }
  ...
  private void safeWrite(PSDK psdk) {
    try {
      ...
      Util.show(NETActivity.this, getString(R.string.send_success));
    } catch (Exception e) {
      e.printStackTrace();
      Util.show(NETActivity.this, getString(R.string.send_failed_reconnect));
    }
  }

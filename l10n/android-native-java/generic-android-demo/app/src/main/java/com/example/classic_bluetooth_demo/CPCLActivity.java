...
public class CPCLActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btnText.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Util.show(CPCLActivity.this, result ? getString(R.string.success) : getString(R.string.failed));
      }
    ...
    btnOta.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        UpdatePrinterCPCL updatePrinter = new UpdatePrinterCPCL(connection,
            Util.readResources(CPCLActivity.this, R.raw.mc240v219), otaHandler);
   ...
   * 2.字体问题，当使用到例如Font.TSS24_MAX1 带MAX这类的字体时需要.font(Font.TSS24_MAX1).mag(true)才会生效
   * .mag(true)是允许倍数放大
  ...
  private void printNow() {
    GenericCPCL _gcpcl = PrintUtil.getInstance().cpcl()
        .page(CPage.builder().width(608).height(1040).copies(sampleNumber).build())
        ...
        .line(CLine.builder().startX(52).startY(88 + 128 + 80).endX(52).endY(88 + 128 + 80 + 144 + 128).lineWidth(2)
            .build())
        .line(CLine.builder().startX(598 - 56 - 16).startY(88 + 128 + 80).endX(598 - 56 - 16).endY(664).lineWidth(2)
            .build())
        .bar(CBar.builder().x(120).y(88 + 12).lineWidth(1).height(80).content("1234567890").codeType(CodeType.CODE128)
            .codeRotation(CodeRotation.ROTATION_0).build())
        ...
        .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 128 + 16).font(Font.TSS24).content("签收人/签收时间")
            .build())
        ...
        .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 24).font(Font.TSS24)
            .content("收姓名" + " " + "13777777777").build())
        .text(CTextCanvas.builder().textX(52 + 20).textY(88 + 128 + 80 + 24 + 32).font(Font.TSS24_MAX1).bold(true)
            .content("南京市浦口区威尼斯水城七街区七街区").alpha(255).build())// 文字用canvas画 支持各国语言
        .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 24).font(Font.TSS24)
            .content("名字" + " " + "13777777777").build())
        .text(CText.builder().textX(52 + 20).textY(88 + 128 + 80 + 144 + 24 + 32).font(Font.TSS24)
        ...
        .line(CLine.builder().startX(0).startY(696 + 80 + 136).endX(598 - 56 - 16).endY(696 + 80 + 136).lineWidth(2)
            .build())
        ...
        .bar(CBar.builder().x(320).y(696 - 4).lineWidth(1).height(56).content("1234567890").codeType(CodeType.CODE128)
            .codeRotation(CodeRotation.ROTATION_0).build())
        ...
        .text(CText.builder().textX(52 + 20).textY(696 + 80 + 28).font(Font.TSS24).content("名字" + " " + "13777777777")
            .build())
        .text(CText.builder().textX(52 + 20).textY(696 + 80 + 28 + 32).font(Font.TSS24).content("南京市浦口区威尼斯水城七街区七街区")
            .build())
        ...
        .text(CText.builder().textX(12 + 8).textY(696 + 80 + 136 + 22 - 5).font(Font.TSS24)
            .content("物品：" + "几个快递" + " " + "12kg").build())
        .box(CBox.builder().topLeftX(598 - 56 - 16 - 120).topLeftY(696 + 80 + 136 + 11).bottomRightX(598 - 56 - 16 - 16)
            .bottomRightY(968 - 11).lineWidth(2).build())
        .mag(CMag.builder().font(Font.TSS24_MAX1).build())// 放大倍数
        .text(CText.builder().textX(598 - 56 - 16 - 120 + 17).textY(696 + 80 + 136 + 11 + 6).font(Font.TSS24_MAX1)
            .bold(true).content("已验视").build())
    ...
    public void handleMessage(Message msg) {
      ...
      switch (transactionTypeEnum) {
        ...
        case MSG_OTA_DATA_COMMAND_SEND_FAILED_PRINTER: {
          ...
          Toast.makeText(CPCLActivity.this, getString(R.string.upgrade_failed), Toast.LENGTH_SHORT).show();
          break;
        }
        ...
        case MSG_OTA_FINISHED_PRINTER: {
          ...
          Toast.makeText(CPCLActivity.this, getString(R.string.upgrade_finished), Toast.LENGTH_SHORT).show();
          break;
        }
      }
    }
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        ...
        case StatusFLAG:
          ...
          switch (hexStr) {
            case "AAFF01FF55":
              Util.show(CPCLActivity.this, getString(R.string.printer_normal));
              break;
            case "AAFF010155":
              Util.show(CPCLActivity.this, getString(R.string.printer_open));
              break;
            case "AAFF010255":
              Util.show(CPCLActivity.this, getString(R.string.paper_empty));
              break;
            case "AAFF010355":
              Util.show(CPCLActivity.this, getString(R.string.paper_jam));
              break;
            case "AAFF010455":
              Util.show(CPCLActivity.this, getString(R.string.printer_low_battery));
              break;
            case "AAFF010555":
              Util.show(CPCLActivity.this, getString(R.string.printer_overheat));
              break;
          }
          break;
      }

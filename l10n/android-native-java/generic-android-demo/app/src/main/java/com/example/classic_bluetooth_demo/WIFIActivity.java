  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    button_send.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (!wifiName.equals("")) {
          ...
          Toast.makeText(WIFIActivity.this, getString(R.string.wifi_credentials_empty), Toast.LENGTH_LONG).show();
        }
      }
    });
    btnSetIp.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (!isValidInput(ip)) {
          Toast.makeText(WIFIActivity.this, getString(R.string.check_ip), Toast.LENGTH_LONG).show();
          return;
        }
        if (!isValidInput(mask)) {
          Toast.makeText(WIFIActivity.this, getString(R.string.check_netmask), Toast.LENGTH_LONG).show();
          return;
        }
        if (!isValidInput(gateway)) {
          Toast.makeText(WIFIActivity.this, getString(R.string.check_gateway), Toast.LENGTH_LONG).show();
          return;
        }
        // 设置成静态ip需传入相关信息
          ...
          public void action(byte[] received) {
            switch (readMark) {
              case OPERATE_WIFI_NAME:
                ...
                String contentSSID = getString(R.string.wifi_name_value, SSID);
              ...
              case OPERATE_WIFI_PASSWORD:
                ...
                String contentPWD = getString(R.string.wifi_password_value, PWD);
              ...
              case OPERATE_WIFI_LINK_STATE:
                ...
                String state = getString(
                    wifiConnected ? R.string.connection_state_connected : R.string.connection_state_disconnected);
                String content = getString(R.string.wifi_connection_state_value, state);
              ...
              case OPERATE_WIFI_DHCP:
                ...
                String dhcpType = getString(isDHCP ? R.string.dhcp_dynamic : R.string.dhcp_static);
                String contentDHCP = getString(R.string.dhcp_state_value, dhcpType);
                runOnUiThread(() -> {
                  if (isDHCP) {
              ...
              case OPERATE_ALL_IP_INFO:
                ...
                if (infos.length > 2) {
                  ...
                  String contentIpInfo = getString(R.string.ip_info_value, ip, mask, gateway);
                  runOnUiThread(() -> {
              ...
              case OPERATE_ALL_WIFI_INFO:
                ...
                String contentWifiInfo = getString(R.string.wifi_info_value, wifiInfo);

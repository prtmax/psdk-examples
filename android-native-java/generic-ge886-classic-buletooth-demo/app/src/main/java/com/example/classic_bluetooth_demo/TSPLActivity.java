  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btnText.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        GenericTSPL _gtspl = tspl.page(TPage.builder().width(50).height(50).build())
          .direction(
            TDirection.builder()
    ...
    btnBitmap.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        GenericTSPL _gtspl = tspl.page(TPage.builder().width(38).height(57).build())
          .direction(
            TDirection.builder()
              .direction(TDirection.Direction.UP_OUT)
              .mirror(TDirection.Mirror.NO_MIRROR)

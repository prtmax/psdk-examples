...
-(void)setUI{
    UIButton *btn0 = [self createButtonWithFrame:CGRectMake(20, 0, 150,50) andTitle:NSLocalizedString(@"paper.type.continuous", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn2 = [self createButtonWithFrame:CGRectMake(20, 70, 150,50) andTitle:NSLocalizedString(@"battery.level", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn4 = [self createButtonWithFrame:CGRectMake(20, 140, 150,50) andTitle:NSLocalizedString(@"name.bluetooth", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn6 = [self createButtonWithFrame:CGRectMake(20, 210, 150,50) andTitle:NSLocalizedString(@"version.bluetooth_firmware", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn8 = [self createButtonWithFrame:CGRectMake(20, 280, 150,50) andTitle:NSLocalizedString(@"SN.printer", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn1 = [self createButtonWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 170, 0, 150,50) andTitle:NSLocalizedString(@"paper.type.label", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn3 = [self createButtonWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 170, 70, 150,50) andTitle:NSLocalizedString(@"status.printer", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn5 = [self createButtonWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 170, 140, 150,50) andTitle:NSLocalizedString(@"MAC.address.bluetooth", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn7 = [self createButtonWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 170, 210, 150,50) andTitle:NSLocalizedString(@"version.printer_firmware", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
    UIButton *btn9 = [self createButtonWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 170, 280, 150,50) andTitle:NSLocalizedString(@"model.printer", nil) andBackgroundColor:UIColor.blueColor andCornerRadius:10];
